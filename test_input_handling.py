...
def test_output_text():
    ...
    actual_reference_file = (
        SPE_PATH + "/Reference_Signature_output/SBS96_De-Novo_Signatures.txt"
    )
    ...
    sig.sigProfilerExtractor(
        ...
        SPE_PATH_SBS_OUTPUT,
        SPE_PATH_SBS_INPUT,
        seeds=SPE_PATH + "/seeds/SBS_seeds/Seeds.txt",
    ...
    shutil.rmtree(
        SPE_PATH
        + "/TextOutput/SBS_output/SBS96/Suggested_Solution/COSMIC_SBS96_Decomposed_Solution"
    )
    shutil.rmtree(
        SPE_PATH
        + "/TextOutput/SBS_output/SBS96/Suggested_Solution/SBS96_De-Novo_Solution/Activities/"
    )
    shutil.rmtree(
        SPE_PATH
        + "/TextOutput/SBS_output/SBS96/Suggested_Solution/SBS96_De-Novo_Solution/Solution_Stats/"
    )
    os.remove(
        SPE_PATH
        + "/TextOutput/SBS_output/SBS96/Suggested_Solution/SBS96_De-Novo_Solution/Signatures/SBS_96_plots_SBS96_De-Novo.pdf"
    )
    os.remove(
        SPE_PATH
        + "/TextOutput/SBS_output/SBS96/Suggested_Solution/SBS96_De-Novo_Solution/Signatures/SBS96_De-Novo_Signatures_SEM_Error.txt"
    )
