...
def plot_1(bases, output_path, project, c_draw):
	for i in range(0,1):
		c_draw.drawImage(output_path+"/ID_sub_plots/"+bases[i][0] + "_" + project+".png", LAYOUT_1_GRAPH[i][X_COORD], LAYOUT_1_GRAPH[i][Y_COORD], width=WIDTH_GRAPH, height=HEIGHT_GRAPH)
...
def plot_2(bases, output_path, project, c_draw):
	for i in range(0,2):
		c_draw.drawImage(output_path+"/ID_sub_plots/"+bases[i][0] + "_" + project+".png", LAYOUT_2_GRAPH[i][X_COORD], LAYOUT_2_GRAPH[i][Y_COORD], width=WIDTH_GRAPH, height=HEIGHT_GRAPH)
...
def plot_3(bases, output_path, project, c_draw):
	for i in range(0,3):
		c_draw.drawImage(output_path+"/ID_sub_plots/"+bases[i][0] + "_" + project+".png", LAYOUT_3_GRAPH[i][X_COORD], LAYOUT_3_GRAPH[i][Y_COORD], width=WIDTH_GRAPH, height=HEIGHT_GRAPH)
...
def plot_4(bases, output_path, project, c_draw):
	for i in range(0,4):
		c_draw.drawImage(output_path+"/ID_sub_plots/"+bases[i][0] + "_" + project+".png", LAYOUT_4_GRAPH[i][X_COORD], LAYOUT_4_GRAPH[i][Y_COORD], width=WIDTH_GRAPH, height=HEIGHT_GRAPH)
...
def gen_plot(de_novo, bases, output_path, project, c, reconstruction, statistics, \
	...
	if reconstruction:
		...
		c.drawImage(output_path+"/ID_sub_plots/"+de_novo+"_"+project+".png", WIDTH_GAP, MID_HEIGHT_LETTER - HEIGHT_GRAPH/2, width=WIDTH_GRAPH, height=HEIGHT_GRAPH)

	#c.drawString(280, MID_HEIGHT_LETTER - 55, "Cosine Similarity: " + str(cos_similarity))
	#c.drawImage("src/Accolade_fermante.png", MID_WIDTH_LETTER - 15, HEIGHT_LETTER * (1/8), width = 15, height = HEIGHT_LETTER * (3/4), mask='auto')
