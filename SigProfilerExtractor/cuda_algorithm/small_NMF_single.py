...
from SigProfilerExtractor.cuda_algorithm.cuda_nmf_single import fit_loop, NMFHandleNew, NMFHandleCreate, NMFHandleDestroy
...
class NMF:
    def __init__(self, V, rank, max_iterations=200000, tolerance=1e-8, test_conv=1000, gpu_id=0, generator=None,
        ...
        if floating_point_precision == 'single':
            ...
            raise ValueError("small_NMF_single.py requires single precision. Use small_NMF_double.py for double precision." )
        else:
            raise ValueError("Precision needs to be 'single'." )
