...
|  | **gpu_algorithm** | String | Defines "cuda" to be the custom CUDA library for NMF update rules and "torch" to be the Torch implementation. Will be effective only if the GPU is used. Default is "cuda".|
